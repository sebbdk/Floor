package dk.sebb.util
{
	...
	{	
		...
		public function getBitMapData(obj:DisplayObject, thumbWidth:Number, thumbHeight:Number):BitmapData {
			var m:Matrix = new Matrix();
			m.scale(thumbWidth / 700, thumbHeight / 700);
			var bmp:BitmapData = new BitmapData(thumbWidth, thumbHeight, false, 0x0);
			bmp.draw(obj, m);
			return bmp;
		}
		...
		public function findPath(from:Vec2, to:Vec2):Array {
			reset();
